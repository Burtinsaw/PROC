...
import { PersonOutline, CreditCard, LockReset, Settings } from '@mui/icons-material';

const items = [
  { key: 0, label: 'Personal Information', icon: <PersonOutline /> },
  { key: 2, label: 'Settings', icon: <Settings /> },
  { key: 3, label: 'Change Password', icon: <LockReset /> },
  { key: 1, label: 'Avatar', icon: <CreditCard />, disabled: false }
];
